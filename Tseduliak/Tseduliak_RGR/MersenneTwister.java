...
public strictfp class MersenneTwister extends java.util.Random implements Serializable, Cloneable
    ...
    /** Reads the entire state of the learning_mersenne_rand.MersenneTwister RNG from the stream */
    ...
    /** Writes the entire state of the learning_mersenne_rand.MersenneTwister RNG to the stream */
    ...
    /**
     * Sets the seed of the learning_mersenne_rand.MersenneTwister using an array of integers.
     * Your array must have a non-zero length.  Only the first 624 integers
     * in the array are used; if the array is shorter than this then
     * integers are repeatedly used in a wrap-around fashion.
     */
    ...
    public static void main(String args[])
    {
        ...
        System.out.println("Output of learning_mersenne_rand.MersenneTwister with new (2002/1/26) seeding mechanism");
        for (j=0;j<1000;j++)
        {
        ...
        System.out.println("The comparison with Random is removed from learning_mersenne_rand.MersenneTwister because it is a proper");
        ...
        // MersenneTwisterFast.java AND learning_mersenne_rand.MersenneTwister.java
